  ...
  return (
    <footer className="mt-8 py-4 sm:py-8 bg-gradient-to-r from-[#C71107] via-[#E67E22] to-[#610804] text-white text-sm">
      <div className="container mx-auto px-3 sm:px-6">
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 sm:gap-6">
          ...
          <div className="col-span-1 mb-3 sm:mb-0">
            ...
            <div className="grid grid-cols-1 gap-0.5">
              ...
              <a href="/about" className="text-xs text-white/80 hover:text-yellow-300 transition-colors">About</a>
              <a href="/contact" className="text-xs text-white/80 hover:text-yellow-300 transition-colors">Contact</a>
            </div>
          </div>
        ...
        {/* Social + Copyright combined for maximum space efficiency */}
        <div className="flex items-center justify-between border-t border-white/10 mt-3 pt-3 text-xs">
          <p>© {new Date().getFullYear()} Manila's Ihawan</p>
          
          <div className="flex space-x-3">
            <a href="https://www.facebook.com/p/Manilas-Ihawan-100064140511078/?hr=1&wtsid=rdr_1npBA3sT44vmMPSEg" aria-label="Facebook" className="text-white hover:text-yellow-300">
              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
              </svg>
            </a>
            <a href="https://www.instagram.com/manilasihawan/?hl=en" aria-label="Instagram" className="text-white hover:text-yellow-300">
              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
